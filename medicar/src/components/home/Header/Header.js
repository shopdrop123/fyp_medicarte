                    ...
                    <div className="mt-4">
                      ...
                      {category && (
                        <motion.ul
                          ...
                          className="text-sm flex flex-col gap-1"
                        >
                          <li className="headerSidenavLi hover:bg-gray-200 p-2 rounded-md">New Arrivals</li>
                          <li className="headerSidenavLi hover:bg-gray-200 p-2 rounded-md">Gadgets</li>
                          <li className="headerSidenavLi hover:bg-gray-200 p-2 rounded-md">Accessories</li>
                          <li className="headerSidenavLi hover:bg-gray-200 p-2 rounded-md">Electronics</li>
                          <li className="headerSidenavLi hover:bg-gray-200 p-2 rounded-md">Others</li>
                        </motion.ul>
                      )}
                    </div>
                    <div className="mt-4">
